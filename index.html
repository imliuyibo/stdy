    ...
    <section class="contactDetails">
      <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <h4>联系方式</h4>
          <p> <i class="icon icon-envelope"></i><a>imliuyibo@163.com</a></p>
          <p> <i class="icon icon-link"></i><a href="https://s1.ax1x.com/2020/06/24/Nw0qoV.jpg">我的微信</a>
          </p>
        </div>
      </div>
    </section>
